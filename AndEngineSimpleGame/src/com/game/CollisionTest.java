...
public class CollisionTest extends BaseGameActivity {
  ...
  private Scene scene;  private Sprite player, target;  
 ...
 @Override  public void onLoadResources() {
   ...
   this.mPlayerTextureRegion = BitmapTextureAtlasTextureRegionFactory
     .createFromAsset(mBitmapTextureAtlas, this, "gfx/Player.png",       0, 0);
   this.mTargetTextureRegion = BitmapTextureAtlasTextureRegionFactory
     .createFromAsset(mBitmapTextureAtlas, this, "gfx/Target.png",       64, 0);
